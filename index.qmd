...
IMROOS <- read_csv("r.o.o.s annotation.csv")
...
IMROOS |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, title = "r.o.o.s - Instant Moments", fill = "Magnitude") +
  theme_minimal() +
...
IMDIVASI |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, title = "Divasi - Instant Moments", fill = "Magnitude") +
  theme_minimal() +
  scale_fill_viridis_c()
```
...
SP |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, title = "Pegassi - Spectral Bells", fill = "Magnitude") +
  scale_fill_viridis_c() +                              
  theme_classic()
...
SP |>
  ...
  theme_classic() +
  labs(x = "", y = "", title = "Pegassi - Spectral Bells")
```
...
ALTF4 |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, title = "Anjunabeats - Alt+F4", fill = "Magnitude") +
  scale_fill_viridis_c() +                              
  theme_classic()
...
ALTF4 |>
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "", y = "", title = "Anjunabeats - Alt+F4")
```
